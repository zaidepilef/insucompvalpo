<?php
	...
	// Place it into your "upload_images" folder mow using the move_uploaded_file() function
	
	$moveResult = move_uploaded_file($fileTmpLoc, "../upload_images/$fileName");
	...
	$target_file = "../upload_images/slider/$fileName";
	$resized_file = "../upload_images/slider/slider_$fileName";
	$wmax = 1200;
	$hmax = 400;
	...
	$target_file = "../upload_images/resized_$fileName";
	$thumbnail = "../upload_images/thumb_$fileName";
	$wthumb = 900;
	$hthumb = 300;
